...
export const nicheCards: NicheCard[] = [
  ...
  {
    slug: 'influencer',
    nicheName: 'Ayla Monteiro',
    headline: 'Conteúdo, presença e parcerias com identidade premium',
    subheadline: 'Posicionamento editorial para creators com visão comercial e estética de alto valor.',
    description:
      'Uma presença digital pensada para valorizar sua imagem, organizar seus canais e fortalecer oportunidades comerciais.',
    featuredNote: 'Parcerias, mídia kit e presença digital premium',
    footerNote: 'Cartão premium para creators que querem presença aspiracional e processo comercial pronto para marcas.',
    locationText: 'São Paulo/SP • Atendimento nacional',
    primaryCtaMessage:
      'Olá! Vi o cartão da Ayla Monteiro e gostaria de falar sobre parceria e presença digital.',
    contactLabels: {
      whatsapp: 'Contato Comercial',
      email: 'commercial@aylamonteiro.com',
    },
    chips: ['+ de 120 mil seguidores', 'Parcerias com marcas', 'Conteúdo autoral', 'Alta taxa de engajamento'],
    serviceLinks: [
      { label: 'Ver Instagram', href: 'https://instagram.com', icon: 'Instagram', kind: 'external' },
      { label: 'Ver TikTok', href: 'https://tiktok.com', icon: 'Music2', kind: 'external' },
      { label: 'Mídia Kit', href: '#', icon: 'Download', kind: 'external' },
    ...
    proofItems: [
      { label: 'Seguidores totais', value: '120k+' },
      { label: 'Taxa de engajamento', value: '7.4%' },
      { label: 'Campanhas premium', value: '90+' },
    ],
    theme: { base: 'from-fuchsia-500/20 via-violet-400/20 to-rose-500/20', accent: 'violet', glow: 'rgba(241,180,214,0.3)' },
  },
  {
    slug: 'clinica',
